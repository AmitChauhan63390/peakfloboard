...
const KanbanBoard = () => {
  ...
  return (
    <div className="m-auto flex min-h-screen w-full items-center justify-center overflow-x-auto overflow-y-hidden px-[40px]">
      ...
      >
        <div className="m-auto flex flex-col md:flex-row gap-4 items-center w-full h-screen">
          <div className="flex flex-col md:flex-row gap-4 w-full overflow-x-auto">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 h-[60px] w-[350px] min-w-[350px] cursor-pointer rounded-lg bg-mainBackgroundColor border-2 border-columnBackgroundColor p-4 ring-rose-500 hover:ring-2 text-white shrink-0"
            >
              <PlusIcon /> Add Column
            </button>
          </div>
